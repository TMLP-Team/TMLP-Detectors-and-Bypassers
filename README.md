...
We do not own any of the detectors and bypassers here. We only keep the latest versions for each detector and bypasser here, keeping them as up-to-date as possible. 
...
我们不拥有此处的检测工具和过检工具。我们仅保留最新的检测工具和过检工具，并尽可能保持实时更新。
